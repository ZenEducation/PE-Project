                ...
                <div class="px-3 -mt-3 mb-5 lg:mb-0">
                    ...
                    <p class="text-opacity-50 font-medium md:text-sm  px-4 mt-1 lg:-mt-3 2xl:mt-6">
                        ...
                        <span class="text-black  dark:text-white">I would like to extend my thanks to Paathshala for my NEET
                            ...
                            teaching
                            and mentoring methodology helped me in a great way. It allowed the professors to monitor my
                            progress
                            at each step. I received feedback pertaining to my areas of improvement and not just some
                            general
                            feedback that is applicable to everyone. That helped me immensely to focus on my weak areas
                        </span>
                        <span class="hidden sm:block text-black  dark:text-white">
                            and strengthen them with time Paathshala’s strategy of early completion of syllabus has provided
                            one of the biggest advantages by
                            giving me 2 years of time only for practice, revision and test series enabling me to constantly
                            improve my scores. The Full Syllabus Tests helped me understand the concepts that I had
                            forgotten
                            with time and also the topics and chapters in which I need to practice more. The professors
                            clarified all my NEET doubts from time to time, making my revision and practice process
                            effective
                            and efficient. Paathshala’s Mistakes Analysis’ Report has been an amazing tool in helping me
                            find
                            out topics and chapters, where I needed more practice and revision. I have given 200 to 250 NEET
                            Full Syllabus Tests. Solving these many FSTs greatly improved my time management skills and also
                            my
                            ability to stay calm and confident in an exam environment
            ...
            <div
                ...
                <div class="px-3 lg:px-5 lg:-mt-4 mb-5 lg:mb-0">
                    ...
                    <p class=" font-medium md:text-sm  px-4 lg:px-0 2xl:px-4 lg:pr-3 mt-2 lg:-mt-1 2xl:mt-2 2xl:pb-64">
                        ...
                        they are true experts in their subjects. The professors here are the best! The environment and
                        ambiance of the classrooms were far beyond my expectation. Good infrastructure, comfortable benches,
                        quality teaching facilities, you name it! Learning here was fun and the environment maintained by
                        the teachers was the cherry on the cake. Our senior students also gave us the information about the
