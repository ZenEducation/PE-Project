<template>
  <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
    ...
    <div class="flex items-center justify-between">
      <!-- Left side -->
      <button
        class="p-2 shrink-0 rounded-full bg-white border border-slate-200 hover:border-slate-300 text-indigo-500 transition duration-150"
      >
      ...
      <div class="flex items-center">
        ...
        <!-- Replies button -->
        <button
          class="flex items-center text-slate-400 hover:text-indigo-500 ml-3"
        >
          <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
            <path
