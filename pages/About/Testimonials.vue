        ...
        <div class="container my-24 px-6 mx-auto">
            ...
            <section class="mb-32  text-center md:text-left">
                ...
                <div class="block rounded-lg bg-gray-200 dark:bg-gray-900">
                    <div class="flex flex-wrap items-center dark:bg-gray-900 bg-gray-200 p-5 ">
                        <div class="grow-0 shrink-0 basis-auto block lg:flex justify-center w-full lg:w-6/12 xl:w-4/12 ">
                            <img src="/images/testimonial/70/aadya-deshpande.jpg"
                        ...
                        <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12 dark:bg-gray-900 bg-gray-200">
                            <div class="px-6 py-12 md:px-12">
                                ...
                                <p class="mb-2 font-semibold text-gray-300 dark:text-[#dddddd]">M.B.B.S | GRANT MEDICAL COLLEGE AND SIR J. J. GROUP OF HOSPITALS, MUMBAI</p>
                                <p class="mb-4 font-bold text-[#696969] dark:text-[#dddddd]">NEET | 692 / 700 <br> NEET All India Rank | 355 <br> XII Boards | 99.33%</p>
