                    ...
                    <div class="grid grid-cols-1 gap-2 mb-2 mt-5">
                        ...
                        <div class=" flex justify-center flex-col px-10">
                            <div class="container border flex justify-between items-center text-black bg-[#f8f8f8] dark:bg-[#161821] dark:text-white dark:border-none dark:hover:bg-[#20ad96] hover:cursor-pointer hover:bg-[#20ad96] hover:text-white transition-all ease-in-out duration-300  mx-10 p-3"
                                ...
                                <h3 class="font-bold">What are the services offered by Photon Ecademy</h3>
                                <div>
                            ...
                            <div class="container border hidden mx-10 p-3" v-else>
                                ...
                                <div class="m-10">
                                    <p class="text-justify text-gray-800">Photon Ecademy services include teaching for JEE, NEET, AIIMS, science entrances aspirants, CBSE, ICSE Boards, Olympiads, Academics Counselling, Homework Checking, Student Mentoring, Academics Planning</p>
                    ...
                    <div class="grid grid-cols-1 gap-2 mb-2 mt-5 mr-2">
                        ...
                        <div class=" flex justify-center flex-col px-10">
                            <div class="container border flex justify-between items-center text-black bg-[#f8f8f8] dark:bg-[#161821] dark:text-white dark:border-none dark:hover:bg-[#20ad96] hover:cursor-pointer hover:bg-[#20ad96] hover:text-white transition-all ease-in-out duration-300  mx-10 p-3"
                                ...
                                <h3 class="font-bold">How Do I Register for Photon Ecademy Test Series</h3>
                                <div>
                        ...
                        <div class=" flex justify-center flex-col px-10">
                            <div class="container border flex justify-between items-center text-black bg-[#f8f8f8] dark:bg-[#161821] dark:text-white dark:border-none dark:hover:bg-[#20ad96] hover:cursor-pointer hover:bg-[#20ad96] hover:text-white transition-all ease-in-out duration-300  mx-10 p-3"
                                ...
                                <h3 class="font-bold">How can I Get a Photon Ecademy Student Mentor</h3>
                                <div>
                        ...
                        <div class=" flex justify-center flex-col px-10">
                            <div class="container border flex justify-between items-center text-black bg-[#f8f8f8] dark:bg-[#161821] dark:text-white dark:border-none dark:hover:bg-[#20ad96] hover:cursor-pointer hover:bg-[#20ad96] hover:text-white transition-all ease-in-out duration-300  mx-10 p-3"
                                ...
                                <h3 class="font-bold">How to enroll for the Photon Ecademy Foundation Course - Prayaag</h3>
                                <div>
